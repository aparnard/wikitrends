...
def process_links(download_link):
	...
	dest = "s3://wikitrends-graphlab/raw_data_last/" + download_link[73:88] + ".csv"
	filtered_data.save(dest)

	return filtered_data

download_links_np = np.genfromtxt("links_3_1.csv", dtype=str, delimiter=',')
links = []
...
ec2 = gl.deploy.ec2_cluster.create(name='wikitrends_cluster_3_1',
