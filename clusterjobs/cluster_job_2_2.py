...
def process_links(download_link):
	...
	gl.product_key.set_product_key('XXXXXXXXXXXXXXXXXXXX')
	...
	dest = "s3://graphlab-wiki-2-2/raw_data_2_2_6/" + download_link[73:88] + ".csv"
	filtered_data.save(dest)

	return filtered_data

download_links_np = np.genfromtxt("links_2_2.csv", dtype=str, delimiter=',')
links = []
...
gl.aws.set_credentials('XXXXXXXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXXXXXXX')
...
ec2 = gl.deploy.ec2_cluster.create(name='wikitrends_cluster_2_2',
                                   s3_path='s3://graphlab-wiki-2-2',
