...
def process_links(download_link):
	...
	dest = "s3://graphlab-wiki-2-1/raw_data_last/" + download_link[73:88] + ".csv"
	filtered_data.save(dest)

	return filtered_data

download_links_np = np.genfromtxt("links_2_1.csv", dtype=str, delimiter=',')
links = []
...
ec2 = gl.deploy.ec2_cluster.create(name='wikitrends_cluster_2_1',
                                   s3_path='s3://graphlab-wiki-2-1',
